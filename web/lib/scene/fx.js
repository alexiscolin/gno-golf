...
function toShore(at, water, reach = 3) {
...
export function bandTo(band, from, angleRad, power, y = BALL_R) {
...
export function makeAim(count = 48) {
  const g = new THREE.Group();
...
export function aimAlong(aim, path, power, height, landing = () => null, tint = null) {
